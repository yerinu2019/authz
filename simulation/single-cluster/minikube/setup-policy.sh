...
kubectl create configmap policy --from-file=policy/rego/istio/authz/policy.rego --from-file=policy/rego/system/log/mask.rego -n api-istio --dry-run=client -o yaml | kubectl -n api-istio apply -f -
